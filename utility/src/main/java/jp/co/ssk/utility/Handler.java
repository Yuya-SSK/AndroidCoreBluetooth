...
public class Handler extends android.os.Handler {
    ...
    public final void sendMessage(int what, int arg1, int arg2, @Nullable Object obj) {
    ...
    public final void sendMessageDelayed(int what, @Nullable Object obj, long delayMillis) {
    ...
    public final void sendMessageDelayed(int what, int arg1, int arg2, @Nullable Object obj, long delayMillis) {
    ...
    public final void sendMessageAtFrontOfQueue(int what, @Nullable Object obj) {
    ...
    public final void sendMessageAtFrontOfQueue(int what, int arg1, int arg2, @Nullable Object obj) {
