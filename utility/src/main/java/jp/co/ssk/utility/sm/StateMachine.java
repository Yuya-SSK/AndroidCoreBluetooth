...
import jp.co.ssk.utility.log.UtilLog;
...
public abstract class StateMachine {
    ...
    private static class SmHandler extends Handler {
        ...
        private SmHandler(@Nullable Looper looper, @NonNull StateMachine sm) {
            super(looper);
            mSm = sm;
        ...
        private void transitionTo(State destState, Object[] objects) {
